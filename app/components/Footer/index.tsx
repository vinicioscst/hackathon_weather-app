...
export function Footer(props : FooterProps){
    return(
        <footer className="w-full flex flex-col items-center gap-4">
            ...
            <p className="text-xs"><a target="_blank" href="https://icons8.com/icon/MVj2tmasj0Pp/rain-cloud" className="underline text-cyan-800">Rain Cloud</a> and <a target="_blank" href="https://icons8.com/icon/42SQTTISIN17/info" className="underline text-cyan-800">Info</a> icons by <a target="_blank" href="https://icons8.com" className="underline text-cyan-800 font-black">Icons8</a></p>
        </footer>
    )
}